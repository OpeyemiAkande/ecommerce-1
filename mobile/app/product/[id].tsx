        ...
        >
          {isAddingToWishlist || isRemovingFromWishlist ? (
            ...
            <Ionicons
              ...
              size={24}
              color={isInWishlist(product._id) ? "#121212" : "#fff"}
            />
          )}
        </TouchableOpacity>
      </View>
      ...
      >
        ...
        <View className="p-6">
          ...
          <View className="flex-row items-center mb-4">
            <View className="flex-row items-center bg-surface px-3 py-3 rounded-full">
    ...
    <SafeScreen>
      <View className="flex-1 items-center justify-center px-6">
        ...
        <Text className="text-text-secondary text-center mt-2">
          This product may have been removed or does&apos;t exist
        </Text>
        <TouchableOpacity
